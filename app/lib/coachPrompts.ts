...
const EXERCISE_INTRO_INSTRUCTION = [
  ...
  "- planDecision säger vad appen beslutat om dagens vikt och varför. Ändras vikten från förra passet — upp eller ner — är det det första användaren undrar över: säg varför med egna ord, före allt annat. Hålls vikten behöver det oftast inte nämnas.",
  ...
  "- Om calibrationTestCandidate finns: det är något annat än opportunity — inte bevisad progression, utan ett erbjudande om att medvetet testa UTANFÖR det bevisade. Använd det sällan, bara när det faktiskt känns som rätt stund (länge sen ni testade på riktigt, eller användaren själv sagt att det känns för lätt) — inte bara för att det råkar finnas. Föreslår du det: säg kort varför (det handlar om att se var gränsen går idag, inte ett krav), och gör tydligt att ett lägre resultat än vanligt är helt okej och väntat, inte ett misslyckande. Nämn aldrig opportunity och calibrationTestCandidate i samma svar.",
