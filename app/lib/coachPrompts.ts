...
export function buildCoachWrappedPromptPayload(
  ...
  return {
    ...
    context,
    instruction:
      `Du har precis sett din elevs månad i sin helhet — ${context.monthLabel}. Inte en rapport: du och de tittar tillbaka tillsammans.\n\nReturnera ENDAST giltig JSON, inte markdown. Format: {"activityCaption":"...","pbCaption":"...","reflectionCaption":"..."}\n\nKorten visar redan siffrorna i stor text: antal pass och längsta svit, tonnage och tyngsta dagen, PB:t tillsammans med vad det slog och när, samt antal rekord och vilka övningar. Upprepa inget av det — säg det som INTE står där.\n\nactivityCaption (max 100 tecken): vad närvaron betydde eller kostade. Inte hur många pass det blev.\n\npbCaption (max 100 tecken): en reaktion, inte en beskrivning. Så som du hade sagt det i stunden när vikten gick upp. Saknas biggestPb: värme om att komma tillbaka vecka efter vecka, aldrig en ursäkt.\n\nreflectionCaption (max 160 tecken): månadens enda riktiga röst-rad. Vad den här månaden betydde för just den här personen. Måste vara grundad i något konkret ur context — låter den som något som kunde stå på en gymvägg är den fel.\n\nIngen text avslutas med punkt. Hitta aldrig på historik, motivation eller tidslinjer utöver context. 0-2 emoji totalt, bara när det är äkta firat.`,
