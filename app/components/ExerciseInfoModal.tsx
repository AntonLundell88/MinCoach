...
function ExerciseMuscleMap({ review }: { review: ReviewedMuscleMap }) {
  ...
  return (
    ...
    >
      <div
        role="img"
        aria-label={`Primärt: ${review.labels.primary}${
          review.labels.active ? `. Jobbar också: ${review.labels.active}` : ""
        }${review.labels.secondary ? `. Sekundärt: ${review.labels.secondary}` : ""}`}
